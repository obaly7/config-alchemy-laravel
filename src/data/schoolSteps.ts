import { StepData } from '@/types/schoolTypes';
...
export const schoolSetupSteps: StepData[] = [
  {
    ...
    fields: [
      ...
      { id: 'notes', label: '  ملاحظات ::: ', labelEn: 'Additional Notes', type: 'textarea' }
    ],
    multiSelect: true,
    allowOther: true,
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'group_work', label: 'شارك في العمل الجماعي بفعالية', labelEn: 'Effectively participated in group work', icon: '👥' },
  ...
  },
  {
    ...
    allowOther: true,
    options: [
      { id: 'school_exhibition', label: 'إظهار عمله في المعرض المدرسي', labelEn: 'Display work in school exhibition', icon: '🏆' },
  ...
  {
    id: 'teaching_plans_curriculum',
    stepNumber: '17',
    title: '17- الخطط التدريسية والمناهج حسب الصفوف',
    titleEn: 'Teaching Plans and Curriculum by Grades',
    description: 'إعداد تفصيلي للخطط التدريسية والمناهج لكل صف دراسي شامل عدد الشعب والحصص والمواد وأساليب التقييم',
    descriptionEn: 'Detailed preparation of teaching plans and curriculum for each grade level including sections, classes, subjects and assessment methods',
    icon: '📋',
    color: 'teal',
    multiSelect: true,
    allowOther: true,
    options: [
      { id: 'kg1_curriculum', label: 'خطة ومنهج الروضة الأولى - KG1', labelEn: 'Kindergarten 1 Curriculum Plan', icon: '🧸' },
      { id: 'kg2_curriculum', label: 'خطة ومنهج الروضة الثانية - KG2', labelEn: 'Kindergarten 2 Curriculum Plan', icon: '🎈' },
      { id: 'kg3_curriculum', label: 'خطة ومنهج الروضة الثالثة - KG3', labelEn: 'Kindergarten 3 Curriculum Plan', icon: '🎯' },
      { id: 'grade1_curriculum', label: 'خطة ومنهج الصف الأول الابتدائي', labelEn: 'Grade 1 Elementary Curriculum Plan', icon: '1️⃣' },
      { id: 'grade2_curriculum', label: 'خطة ومنهج الصف الثاني الابتدائي', labelEn: 'Grade 2 Elementary Curriculum Plan', icon: '2️⃣' },
      { id: 'grade3_curriculum', label: 'خطة ومنهج الصف الثالث الابتدائي', labelEn: 'Grade 3 Elementary Curriculum Plan', icon: '3️⃣' },
      { id: 'grade4_curriculum', label: 'خطة ومنهج الصف الرابع الابتدائي', labelEn: 'Grade 4 Elementary Curriculum Plan', icon: '4️⃣' },
      { id: 'grade5_curriculum', label: 'خطة ومنهج الصف الخامس الابتدائي', labelEn: 'Grade 5 Elementary Curriculum Plan', icon: '5️⃣' },
      { id: 'grade6_curriculum', label: 'خطة ومنهج الصف السادس الابتدائي', labelEn: 'Grade 6 Elementary Curriculum Plan', icon: '6️⃣' },
      { id: 'grade7_curriculum', label: 'خطة ومنهج الصف السابع الإعدادي', labelEn: 'Grade 7 Middle School Curriculum Plan', icon: '7️⃣' },
      { id: 'grade8_curriculum', label: 'خطة ومنهج الصف الثامن الإعدادي', labelEn: 'Grade 8 Middle School Curriculum Plan', icon: '8️⃣' },
      { id: 'grade9_curriculum', label: 'خطة ومنهج الصف التاسع الإعدادي', labelEn: 'Grade 9 Middle School Curriculum Plan', icon: '9️⃣' },
      { id: 'grade10_curriculum', label: 'خطة ومنهج الصف العاشر الثانوي', labelEn: 'Grade 10 High School Curriculum Plan', icon: '🔟' },
      { id: 'grade11_curriculum', label: 'خطة ومنهج الصف الحادي عشر الثانوي', labelEn: 'Grade 11 High School Curriculum Plan', icon: '📚' },
      { id: 'grade12_curriculum', label: 'خطة ومنهج البكالوريا', labelEn: 'Baccalaureate Curriculum Plan', icon: '🎓' }
    ]
  }
];
