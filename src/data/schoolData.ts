...
export const schoolSetupSteps: StepData[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'hijri_new_year', label: 'رأس السنة الهجرية (2026-06-16)', labelEn: 'Hijri New Year (2026-06-16)', icon: '☪️' },
      { id: 'good_friday_west', label: 'الجمعة العظيمة - غربي (2026-04-03)', labelEn: 'Good Friday - Western (2026-04-03)', icon: '✝️' },
      { id: 'easter_west', label: 'عيد الفصح - غربي (2026-04-05)', labelEn: 'Easter - Western (2026-04-05)', icon: '🐰' },
      { id: 'good_friday_east', label: 'الجمعة العظيمة - شرقي (2026-04-10)', labelEn: 'Good Friday - Eastern (2026-04-10)', icon: '☦️' },
